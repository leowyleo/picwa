...
- 按图片真实创建时间浏览
- Today、7 Days、30 Days 和 All 时间范围
- 小、中、大三档浏览密度
- 多选、复制和在访达中显示
- 仅扫描用户主动选择的文件夹
- 本地索引，不上传原始图片
...
照片,图片,时间线,相册,浏览,整理,本地,macOS,photo,timeline

## English draft

### Subtitle

Browse photos by capture time
...
photo,image,timeline,organize,metadata,local,Mac,Finder,images
