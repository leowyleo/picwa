...
- GitHub 仓库：`https://github.com/leowyleo/picwa`
- Cloudflare Pages 输出目录：`docs/site`
- 公网入口：`https://picwa.leowy.cc/`
- 英文首页：`https://picwa.leowy.cc/`
- 中文首页：`https://picwa.leowy.cc/zh/`
- 英文隐私政策：`https://picwa.leowy.cc/privacy`
- 中文隐私政策：`https://picwa.leowy.cc/zh/privacy`
